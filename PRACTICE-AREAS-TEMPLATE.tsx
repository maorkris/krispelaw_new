// תבנית זו היא דוגמה ליצירת דפי תחומי עיסוק נוספים
// העתיקו את הקוד הזה ושנו את הפרטים הרלוונטיים
...
export default function PracticeAreaTemplate() {
  return (
    <div className="min-h-screen">
      ...
      {/* Hero - שנו את האייקון והטקסט */}
      <section className="pt-32 pb-20 px-4 bg-gradient-to-b from-gold-50 to-white">
        <div className="container mx-auto max-w-4xl text-center">
          <div className="text-4xl mb-6">📋</div> {/* שנו אייקון */}
          <h1 className="text-5xl font-bold text-gray-900 mb-6">כותרת התחום</h1> {/* שנו כותרת */}
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-gray-600 mb-8 leading-relaxed">
            תוכן ראשי - כתבו כאן על התחום, מה הוא כולל, למה זה חשוב.
          </p>

          <h3 className="text-2xl font-bold text-gray-900 mb-6">השירותים שאנו מעניקים</h3>
          
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h4 className="text-xl font-bold text-gray-900 mb-3">שירות 1</h4>
              <p className="text-gray-600">תיאור השירות הראשון</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h4 className="text-xl font-bold text-gray-900 mb-3">שירות 2</h4>
              <p className="text-gray-600">תיאור השירות השני</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h4 className="text-xl font-bold text-gray-900 mb-3">שירות 3</h4>
              <p className="text-gray-600">תיאור השירות השלישי</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h4 className="text-xl font-bold text-gray-900 mb-3">שירות 4</h4>
              <p className="text-gray-600">תיאור השירות הרביעי</p>
            </div>
          </div>
          ...
          <div className="bg-gold-50 border-r-4 border-gold-600 p-8 mb-12">
            ...
            <p className="text-gray-600 leading-relaxed">
              כתבו כאן על הניסיון, המומחיות והגישה האישית שלכם בתחום זה.
            </p>
          </div>

          <h3 className="text-2xl font-bold text-gray-900 mb-6">יתרונות העבודה איתנו</h3>
          <ul className="space-y-3 mb-12">
            <li className="flex items-start gap-3">
              <span className="text-gold-600 text-xl">✓</span>
              <span className="text-gray-600">יתרון ראשון</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-gold-600 text-xl">✓</span>
              <span className="text-gray-600">יתרון שני</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-gold-600 text-xl">✓</span>
              <span className="text-gray-600">יתרון שלישי</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-gold-600 text-xl">✓</span>
              <span className="text-gray-600">יתרון רביעי</span>
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-gold-600 text-white">
        <div className="container mx-auto text-center max-w-3xl">
          <h2 className="text-4xl font-bold mb-6">צריכים עזרה בתחום זה?</h2>
          <p className="text-xl mb-8 opacity-90">
            אנו כאן כדי לעזור לכם
          </p>
